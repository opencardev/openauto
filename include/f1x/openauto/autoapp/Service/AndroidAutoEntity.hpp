...
class AndroidAutoEntity : public IAndroidAutoEntity,
  ...
  public:
    AndroidAutoEntity(boost::asio::io_service& ioService,
                      ...
                      configuration::IConfiguration::Pointer configuration, ServiceList serviceList,
    ...
    // TODO: on channel open request... on channel close...  on navigation focus, on voice session
    // notification, on user switch, on call availability, on service disc update, on battery
    // status, on car connected devices
