...
class ServiceFactory : public IServiceFactory {
  ...
  private:
    ...
    IService::Pointer createGenericNotificationService(
    ...
    IService::Pointer createMediaPlaybackStatusService(
        aasdk::messenger::IMessenger::Pointer messenger);

    void createMediaSinkServices(ServiceList &serviceList,
                                 aasdk::messenger::IMessenger::Pointer messenger);
    void createMediaSourceServices(ServiceList &serviceList,
                                   aasdk::messenger::IMessenger::Pointer messenger);

    IService::Pointer createNavigationStatusService(
        aasdk::messenger::IMessenger::Pointer messenger);
