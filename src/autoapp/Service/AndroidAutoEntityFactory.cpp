...
AndroidAutoEntityFactory::AndroidAutoEntityFactory(
    boost::asio::io_service &ioService, configuration::IConfiguration::Pointer configuration,
...
IAndroidAutoEntity::Pointer AndroidAutoEntityFactory::create(
    ...
    auto transport(
        std::make_shared<aasdk::transport::USBTransport>(ioService_, std::move(aoapDevice)));
