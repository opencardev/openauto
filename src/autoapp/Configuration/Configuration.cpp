...
void Configuration::load() {
    ...
    try {
        ...
        videoFPS_ = static_cast<aap_protobuf::service::media::sink::message::VideoFrameRateType>(
            iniConfig.get<uint32_t>(cVideoFPSKey,
                                    static_cast<uint32_t>(30)));  // Default to 30 FPS

        videoResolution_ =
            static_cast<aap_protobuf::service::media::sink::message::VideoCodecResolutionType>(
        ...
        bluetoothAdapterType_ = static_cast<BluetoothAdapterType>(iniConfig.get<uint32_t>(
            cBluetoothAdapterTypeKey, static_cast<uint32_t>(BluetoothAdapterType::NONE)));
        ...
        audioOutputBackendType_ = static_cast<AudioOutputBackendType>(iniConfig.get<uint32_t>(
            cAudioOutputBackendType, static_cast<uint32_t>(AudioOutputBackendType::RTAUDIO)));
    } catch (const boost::property_tree::ini_parser_error &e) {
        LOG_WARN_STREAM(CONFIG, "[Configuration] failed to read configuration file: "
...
void Configuration::reset() {
    ...
    // Using numeric defaults until aap_protobuf enums are available
    videoFPS_ =
        static_cast<aap_protobuf::service::media::sink::message::VideoFrameRateType>(30);  // 30 FPS
    videoResolution_ =
        static_cast<aap_protobuf::service::media::sink::message::VideoCodecResolutionType>(
            1);  // 800x480
    screenDPI_ = 140;
...
bool Configuration::hasTouchScreen() const {
    ...
    LOG_INFO_STREAM(CONFIG, "[Touchdev] " << "Querying available touch devices ["
...
void Configuration::hideBrightnessControl(bool value) { hideBrightnessControl_ = value; }

bool Configuration::hideBrightnessControl() const { return hideBrightnessControl_; }
...
void Configuration::setMp3MasterPath(const std::string &value) { mp3MasterPath_ = value; }
...
void Configuration::setMp3SubFolder(const std::string &value) { mp3SubFolder_ = value; }
...
void Configuration::setTouchscreenEnabled(bool value) { enableTouchscreen_ = value; }

bool Configuration::playerButtonControl() const { return enablePlayerControl_; }

void Configuration::playerButtonControl(bool value) { enablePlayerControl_ = value; }

Configuration::ButtonCodes Configuration::getButtonCodes() const { return buttonCodes_; }

void Configuration::setButtonCodes(const ButtonCodes &value) { buttonCodes_ = value; }
...
std::string Configuration::getBluetoothAdapterAddress() const { return bluetoothAdapterAddress_; }

void Configuration::setBluetoothAdapterAddress(const std::string &value) {
    bluetoothAdapterAddress_ = value;
}

bool Configuration::getWirelessProjectionEnabled() const { return wirelessProjectionEnabled_; }

void Configuration::setWirelessProjectionEnabled(bool value) { wirelessProjectionEnabled_ = value; }

bool Configuration::musicAudioChannelEnabled() const { return _audioChannelEnabledMedia; }

void Configuration::setMusicAudioChannelEnabled(bool value) { _audioChannelEnabledMedia = value; }

bool Configuration::guidanceAudioChannelEnabled() const { return _audioChannelEnabledGuidance; }

void Configuration::setGuidanceAudioChannelEnabled(bool value) {
    _audioChannelEnabledGuidance = value;
}

bool Configuration::systemAudioChannelEnabled() const { return _audioChannelEnabledSystem; }

void Configuration::setSystemAudioChannelEnabled(bool value) { _audioChannelEnabledSystem = value; }

bool Configuration::telephonyAudioChannelEnabled() const { return _audioChannelEnabledTelephony; }
...
QString Configuration::getCSValue(QString searchString) const {
    ...
    LOG_DEBUG_STREAM(CONFIG, "[Configuration] CS param calls disabled, returning empty for: "
    ...
    if (inFile) {
        while (inFile.good()) {
            ...
            if (line[0] != '#') {
                ...
                if (pos != std::string::npos)  // string::npos is returned if string is not found
                {
                    ...
                    value.replace("\"", "");
                    LOG_DEBUG_STREAM(CONFIG, "[Configuration] CS param found: "
                                                 << searchString.toStdString()
        ...
        LOG_WARN_STREAM(CONFIG,
                        "[Configuration] unable to find cs param: " << searchString.toStdString());
        ...
        LOG_WARN(
            CONFIG,
            "[Configuration] unable to open cs param file (/boot/crankshaft/crankshaft_env.sh)");
        LOG_WARN(CONFIG, "[Configuration] Fallback to /opt/crankshaft/crankshaft_default_env.sh)");
...
QString Configuration::getParamFromFile(QString fileName, QString searchString) const {
    LOG_DEBUG_STREAM(CONFIG, "[Configuration] Request param from file: "
        ...
        while (inFile.good()) {
            ...
            if (line[0] != '#') {
                ...
                if (pos != std::string::npos)  // string::npos is returned if string is not found
                {
                    ...
                    QString value = line.substr(equalPosition + 1).c_str();
                    value.replace("\"", "");
                    LOG_DEBUG_STREAM(CONFIG, "[Configuration] Param from file: "
                                                 << fileName.toStdString()
...
void Configuration::readButtonCodes(boost::property_tree::ptree &iniConfig) {
    ...
    this->insertButtonCode(
        ...
        static_cast<aap_protobuf::service::media::sink::message::KeyCode>(3));  // KEYCODE_HOME
    this->insertButtonCode(
        iniConfig, cInputPhoneButtonKey,
        static_cast<aap_protobuf::service::media::sink::message::KeyCode>(5));  // KEYCODE_CALL
    this->insertButtonCode(
        iniConfig, cInputCallEndButtonKey,
        static_cast<aap_protobuf::service::media::sink::message::KeyCode>(6));  // KEYCODE_ENDCALL
...
void Configuration::writeButtonCodes(boost::property_tree::ptree &iniConfig) {
    ...
    iniConfig.put<bool>(cInputPlayButtonKey,
                        std::find(buttonCodes_.begin(), buttonCodes_.end(),
                                  static_cast<aap_protobuf::service::media::sink::message::KeyCode>(
                                      126)) != buttonCodes_.end());
    iniConfig.put<bool>(cInputPauseButtonKey,
                        std::find(buttonCodes_.begin(), buttonCodes_.end(),
                                  static_cast<aap_protobuf::service::media::sink::message::KeyCode>(
                                      127)) != buttonCodes_.end());
