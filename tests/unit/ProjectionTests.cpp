...
class ProjectionTest : public ::testing::Test {
  protected:
    void SetUp() override {
        ...
        ON_CALL(*mockConfiguration, getCSValue(QString("VIDEO_FPS"))).WillByDefault(Return("60"));
...
TEST_F(ProjectionTest, VideoOutputCreation) {
    ...
    EXPECT_CALL(*mockConfiguration, getCSValue(QString("VIDEO_FPS"))).WillRepeatedly(Return("60"));
