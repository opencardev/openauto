...
TEST_F(ConfigurationTest, AudioOutputConfiguration) {
    ...
    configuration->setAudioOutputBackendType(audioOutputBackendType ==
                                                     AudioOutputBackendType::RTAUDIO
                                                 ? AudioOutputBackendType::QT
                                                 : AudioOutputBackendType::RTAUDIO);
...
TEST_F(ConfigurationTest, VideoOutputConfiguration) {
    ...
    configuration->setVideoResolution(
        videoResolution == VideoResolution::_480 ? VideoResolution::_720 : VideoResolution::_480);
    ...
    EXPECT_EQ(fps == VideoFPS::_30 ? VideoFPS::_60 : VideoFPS::_30, configuration->getVideoFPS());
}
