  ...
  protected:
    void SetUp() override {
        ...
        mockConnectedAccessoriesEnumerator =
            std::make_shared<NiceMock<aasdk::usb::MockConnectedAccessoriesEnumerator>>();
        mockAndroidAutoEntityFactory =
            std::make_shared<NiceMock<service::MockAndroidAutoEntityFactory>>();
        ...
        ON_CALL(*mockAndroidAutoEntityFactory,
                create(testing::An<aasdk::usb::IAOAPDevice::Pointer>()))
            .WillByDefault(Return(mockAndroidAutoEntity));

        ON_CALL(*mockAndroidAutoEntityFactory,
                create(testing::An<aasdk::tcp::ITCPEndpoint::Pointer>()))
            .WillByDefault(Return(mockAndroidAutoEntity));

        app = std::make_unique<App>(ioService, *mockUsbWrapper, *mockTcpWrapper,
                                    *mockAndroidAutoEntityFactory, mockUsbHub,
                                    mockConnectedAccessoriesEnumerator);
    }
    ...
    std::shared_ptr<NiceMock<aasdk::usb::MockConnectedAccessoriesEnumerator>>
        mockConnectedAccessoriesEnumerator;
